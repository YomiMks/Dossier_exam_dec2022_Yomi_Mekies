...
export default function EnhancedTable(props) {
    ...
    const handleSelectAllClick = (event) => {
        if (event.target.checked) {
            const newSelected = props.structuresData.map((n) => n.name);
    ...
    const emptyRows =
        page > 0 ? Math.max(0, (1 + page) * rowsPerPage - props.structuresData.length) : 0;
        ...
        <Box sx={{ width: '100%', marginTop: '10%' }}>
            <Paper sx={{ width: '100%', mb: 2 }}>
                ...
                <TableContainer>
                    ...
                    >
                        <EnhancedTableHead
                            ...
                            rowCount={props.structuresData.length}
                        />
                        <TableBody>
                 ...
                 rows.slice().sort(getComparator(order, orderBy)) */}
                            {stableSort(props.structuresData, getComparator(order, orderBy))
                              ...
                              />*/}
                                            ...
                                            <TableCell align="right">
                                                <Button variant="contained" onClick={() => props.fetchApiDeleteStructure(row.id)}>Supprimer</Button>
                                            </TableCell>
                                        </TableRow>
                                    );
                                })}
                ...
                <TablePagination
                    ...
                    component="div"
                    count={props.structuresData.length}
